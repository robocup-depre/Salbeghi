...
class BNO055:
	...
	def __init__(self, sensorId=-1, address=0x29):
		...
		self._mode = BNO055.OPERATION_MODE_IMUPLUS # BNO055.OPERATION_MODE_ACCGYRO #OPERATION_MODE_NDOF #BNO055.OPERATION_MODE_IMUPLUS
		#BNO055.OPERATION_MODE_NDOF


	def begin(self, mode=None):
		if mode is None: mode = self._mode#BNO055.OPERATION_MODE_NDOF
		# Open I2C bus
