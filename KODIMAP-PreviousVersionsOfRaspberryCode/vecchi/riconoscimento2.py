        ...
        try:
            ...
            while(self.Avvia):
                if(self.avvio):
                    ...
                    while (ctry):
                        try:
                            frametemp = self.q_cam.get_nowait()
                            ctrz = 1
                        except Queue.Empty:
                            if(ctrz):
                                ctry = 0
                    ...
                    '''
                    ret, frame = self.cap.read() 
                    frametemp = frame#self.q_cam.get()
                    ...
                    #mask_white=cv2.inRange(frame_hsv, self.low_white, self.up_white)
                    #mask_white=self.definisci(mask_white,1,4)
                    ...
                    #white = self.trova_colori(mask_white_inv,(255,255,255))
